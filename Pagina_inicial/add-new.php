...
<head>
    ...
    <title style="background-color: blueviolet; color: black;">Cadastro de Usuários</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-mute" style="background-color: blueviolet; color: white; margin-left: 200px; margin-right: 200px;">Complete o formulário abaixo</p>
        </div>
            ...
            <form action="" method="post" style="width:50vw; min-width:300px;">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="first_name" placeholder="Fulano">
                    </div>

                    <div class="col">
                        <label class="form-label">Sobrenome:</label>
                        <input type="text" class="form-control" name="last_name" placeholder="Souza">
                    </div>
                </div>
